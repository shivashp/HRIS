...
<div class="content">
  ...
  <div class ="form-input">
    <div class="card">
        <div class="card-content">
            <h4 class="card-title">Add Disciplinary Type</h4>
            <form class="form-horizontal">
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                      <label class="col-md-3 label-on-left">Disciplinary Type</label>
                      <div class="col-md-9">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                              <input type="text" id="disciplinary-type" class="form-control">
                          </div>
                      </div>
                  </div><!--row-->
                  <div class="row">
                      <label class="col-md-3 label-on-left">Disciplinary Code</label>
                      <div class="col-md-9">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                              <input type="text" id="disciplinary-code" class="form-control">
                          </div>
                      </div>
                  </div><!--row-->
                </div>
  ...
  <div class="card">
      ...
      <div class="card-content">
          <h4 class="card-title">Disciplinary Types</h4>
...
<script src="scripts/disciplinary-type.js" charset="utf-8"></script>
<script>
  active('disciplinary-type', 'sub-link')
  active('config')
  $(".card").show();
  $(".page-loader").hide();
</script>
